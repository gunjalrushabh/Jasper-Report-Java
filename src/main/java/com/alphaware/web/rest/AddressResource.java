...
import com.alphaware.repository.AddressRepository;
import com.alphaware.service.AddressService;
...
/**
 * REST controller for managing {@link com.alphaware.domain.Address}.
 */
@RestController
@RequestMapping("/api")
public class AddressResource {
    ...
    private static final String ENTITY_NAME = "customerDiginextAddress";
    ...
    public ResponseEntity<AddressDTO> updateAddress(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, addressDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<AddressDTO> partialUpdateAddress(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, addressDTO.getId())
        );
    }
